		...
		<div class="wrapper">
			<div style="margin-left:300px;background-color:#999;width:349px;"><img src="css/layout/login/2.png"/></div>
				...
				<div id="form_wrapper" class="form_wrapper" style="margin-left:298px;">
					...
					<form class="forgot_password active" style="width:349px;">
						...
						<div class="bottom">
							...
							<a href="index.php" rel="login" class="">Suddenly remebered? Log in here</a>
<!--							<a href="register.html" rel="register" class="">You don't have an account? Register here</a>
-->							<div class="clear"></div>
						</div>
					</form>
				</div>
